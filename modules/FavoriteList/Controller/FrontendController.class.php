...
class FrontendController extends \Cx\Core\Core\Model\Entity\SystemComponentFrontendController
{
    public function parsePage(\Cx\Core\Html\Sigma $template, $cmd)
    {
        ...
        switch ($cmd) {
            case 'mail':
                $this->mail($template, $catalog);
                break;
            case 'print':
                $this->printing($template, $catalog);
                break;
            case 'recommendation':
                $this->recommendation($template, $catalog);
                break;
            case 'inquiry':
                $this->inquiry($template, $catalog);
                break;
            default:
                $this->overview($template, $catalog);
                break;
        }
    }

    /**
     * Parses the mail page
     *
     * @access protected
     * @global $_ARRAYLANG
     * @param $template     object  the template to parse in
     * @param $catalog      array   catalog of this user session
     */
    protected function mail($template, $catalog)
    {
        global $_ARRAYLANG;
     ...
     * @param $catalog      array   catalog of this user session
     */
    protected function printing($template, $catalog)
    {
        global $_ARRAYLANG;
    ...
    /**
     * Parses the recommendation page
     *
     * @access protected
     * @global $_ARRAYLANG
     * @param $template     object  the template to parse in
     * @param $catalog      array   catalog of this user session
     */
    protected function recommendation($template, $catalog)
    {
        global $_ARRAYLANG;
     ...
     * @param $catalog      array   catalog of this user session
     */
    protected function inquiry($template, $catalog)
    {
        global $_ARRAYLANG;
    ...
    /**
     * Parses the overview/default page
     *
     * @access protected
     * @global $_ARRAYLANG
     * @param $template     object  the template to parse in
     * @param $catalog      array   catalog of this user session
     */
    protected function overview($template, $catalog)
    {
        global $_ARRAYLANG;
