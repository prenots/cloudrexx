...
class PayrexxProcessor
{
    ...
    public static function getModalCode()
    {
        ...
        $settingDb = SettingDb::getArray('Shop', 'config');
        ...
        $order = Order::getById($_SESSION['shop']['order_id']);
        ...
        $gateway->setCurrency(Currency::getCodeById($order->currency_id()));
        ...
        $gateway->addField('country', \Country::getAlpha2ById($order->billing_country_id()));
...
EOF;
    ...
    public static function checkIn()
    {
        ...
        $arrSettings = SettingDb::getArray('Shop', 'config');
