...
$_ARRAYLANG['TXT_ACCESS_ACTIVATION_BY_AUTHORIZED_PERSON'] = "Aktivierung durch eine autorisierte Person (Siehe Backend-Gruppenrechte unter der Benutzerverwaltung).";
$_ARRAYLANG['TXT_ACCESS_ACTIVATION_BY_USER'] = "Aktivierung durch den Benutzer";
...
$_ARRAYLANG['TXT_ACCESS_CLICK_UNLOCK_PAGE_MODIF'] = "Klicken Sie auf das Symbol um den Modifikationsschutz dieser Seite zu entfernen.";
...
$_ARRAYLANG['TXT_ACCESS_GROUP_ASSOCIATION_TEXT'] = "Wählen Sie die Gruppen, welchen ein neu registrierter Benutzer zugeordnet werden soll. <br/>Beachten Sie: Ein Benutzer, der nicht zumindest einer Gruppe zugeordnet ist, kann sich im System nicht anmelden!";
...
$_ARRAYLANG['TXT_ACCESS_PASSWORD_MD5_ENCRYPTED'] = "Das Kennwort wird mit dem MD5 Algorithmus verschlüsselt.";
$_ARRAYLANG['TXT_ACCESS_PASSWORD_MINIMAL_CHARACTERS'] = "Das Passwort muss mindestens 6 Zeichen lang sein.<br /><br />Die Komplexitätsvoraussetzung kann in den Grundeinstellungen aktiviert werden.";
$_ARRAYLANG['TXT_ACCESS_PASSWORD_MINIMAL_CHARACTERS_WITH_COMPLEXITY'] = "Das Passwort muss mindestens 6 Zeichen lang sein und mindestens einen Gross-, einen Kleinbuchstaben und eine Zahl enthalten.<br /><br />Die Komplexitätsvoraussetzung kann in den Grundeinstellungen deaktiviert werden.";
...
$_ARRAYLANG['TXT_ACCESS_SPECIAL_MENU_PERM'] = "Spezielle Erlaubnis für Benutzer, welchen keine Berechtigung durch Gruppenzuweisung erteilt wurden:";
...
$_ARRAYLANG['TXT_ACCESS_TIME_PERIOD_ACTIVATION_TIME'] = "Zeitperiode in Stunden bevor die Aktivierung abläuft. (0 - 24 Stunden; 0 für unlimitiert)";
...
$_ARRAYLANG['TXT_ACCESS_NO_USER_WITH_SAME_ID'] = "Sie können Ihr eigenes Benutzerkonto nicht deaktivieren.";
...
$_ARRAYLANG['TXT_ACCESS_SESSION_ON_INTERVAL'] = "Aktualisierungsintervall";
$_ARRAYLANG['TXT_ACCESS_SESSION_TITLE'] = "Benutzersitzung";
$_ARRAYLANG['TXT_ACCESS_SESSION_DESCRIPTION'] = "Definieren Sie hier, wie oft (0-300 Sekunden) die Sitzung eines Benutzers aktualisiert werden soll. Ein Intervall von 0 Sekunden bedeutet, dass die Sitzung bei jeder Seitenanfrage aktualisiert wird.";
...
$_ARRAYLANG['TXT_ACCESS_PASSWORD_TOO_SHORT'] = "Zu kurz";
$_ARRAYLANG['TXT_ACCESS_PASSWORD_WEAK'] = "Schwach";
...
$_ARRAYLANG['TXT_ACCESS_SOCIALLOGIN_PROVIDER_ENABLED'] = "Aktivieren";
$_ARRAYLANG['TXT_ACCESS_SOCIALLOGIN_SHOW_SIGN_UP'] = "Registrationsformular immer anzeigen";
...
$_ARRAYLANG['TXT_ACCESS_SOCIALLOGIN_PERMISSION_DENIED'] = "Sie sind nicht dazu berechtigt diese Einstellungen einzusehen.";
