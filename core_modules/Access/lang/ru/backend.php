...
$_ARRAYLANG['TXT_ACCESS_ASSOCIATED_GROUPS'] = "Назначенные Группы";
$_ARRAYLANG['TXT_ACCESS_ATTRIBUTE'] = "Eigenschaft";
$_ARRAYLANG['TXT_ACCESS_AVAILABLE_GROUPS'] = "Доступные Группы";
$_ARRAYLANG['TXT_ACCESS_BACK'] = "Назад";
$_ARRAYLANG['TXT_ACCESS_SETTINGS'] = "Установки";
$_ARRAYLANG['TXT_ACCESS_SAVE'] = "Сохранить";
$_ARRAYLANG['TXT_ACCESS_CHECKBOX'] = "Чекбокс";
$_ARRAYLANG['TXT_ACCESS_USER_ACCOUNT_VERIFICATION'] = "СООТВЕТСТВИЕ обязательные ( свойств профиля )";
$_ARRAYLANG['TXT_ACCESS_USER_ACCOUNT_VERIFICATION_TEXT'] = "Обязательные поля должны быть проверены и установить";
?>
