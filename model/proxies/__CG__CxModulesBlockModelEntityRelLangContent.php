 ...
 */
class RelLangContent extends \Cx\Modules\Block\Model\Entity\RelLangContent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'content', 'active', 'block', 'locale', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelLangContent $proxy) {
