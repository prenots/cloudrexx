 ...
 */
class TwofactorAuthentication extends \Cx\Core\User\Model\Entity\TwofactorAuthentication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'userId', 'name', 'data', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TwofactorAuthentication $proxy) {
