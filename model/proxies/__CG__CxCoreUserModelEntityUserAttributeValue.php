...
class UserAttributeValue extends \Cx\Core\User\Model\Entity\UserAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'attributeId', 'userId', 'historyId', 'value', 'userAttribute', 'userProfile', 'validators', 'virtual');
        }
    ...
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getHistoryId();
        }
    ...
    public function setHistoryId($historyId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHistoryId', array($historyId));

        return parent::setHistoryId($historyId);
    }
