 ...
 */
class Setting extends \Cx\Modules\Block\Model\Entity\Setting implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'value', 'validators', 'virtual');
        }
