 ...
 */
class TargetingOption extends \Cx\Modules\Block\Model\Entity\TargetingOption implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'filter', 'value', 'block', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TargetingOption $proxy) {
