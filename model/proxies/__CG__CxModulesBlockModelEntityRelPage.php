 ...
 */
class RelPage extends \Cx\Modules\Block\Model\Entity\RelPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'placeholder', 'block', 'page', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelPage $proxy) {
    ...
    public function setPlaceholder($placeholder)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPlaceholder', array($placeholder));
    ...
    public function getPlaceholder()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPlaceholder', array());
