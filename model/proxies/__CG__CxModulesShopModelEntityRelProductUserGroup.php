 ...
 */
class RelProductUserGroup extends \Cx\Modules\Shop\Model\Entity\RelProductUserGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'productId', 'usergroupId', 'products', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelProductUserGroup $proxy) {
    ...
    public function setUsergroupId($usergroupId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsergroupId', array($usergroupId));
    ...
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUsergroupId();
        }
