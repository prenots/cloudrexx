...
function getTableList() {
    ...
    $arrContrexxTables = array(
        ...
        DBPREFIX.'module_calendar_category',
        ...
        DBPREFIX.'module_calendar_rel_event_host',
        DBPREFIX.'module_calendar_settings',
        DBPREFIX.'module_calendar_settings_section',
        ...
        DBPREFIX.'module_crm_customer_documents',
        DBPREFIX.'module_crm_customer_membership',
        DBPREFIX.'module_crm_customer_types',
        DBPREFIX.'module_crm_datasources',
        DBPREFIX.'module_crm_deals',
        DBPREFIX.'module_crm_industry_types',
        DBPREFIX.'module_crm_industry_type_local',
        DBPREFIX.'module_crm_memberships',
        DBPREFIX.'module_crm_membership_local',
        DBPREFIX.'module_crm_notes',
        DBPREFIX.'module_crm_settings',
        DBPREFIX.'module_crm_stages',
        DBPREFIX.'module_crm_success_rate',
