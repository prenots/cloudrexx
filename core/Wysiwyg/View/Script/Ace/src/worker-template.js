...
ace.define("ace/mode/template_worker",[], function(require, exports, module) {
"use strict";
...
(function() {
    ...
    this.onUpdate = function() {
        ...
        var modValue = value.replace(new RegExp(/\[\[[A-Z0-9_]+\]\]/, 'g'), '');
        if (!modValue)
            return;
        ...
        if (this.context)
            parser.parseFragment(modValue, this.context);
        else
            parser.parse(modValue);
