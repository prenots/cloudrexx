...
// TODO: is this actually the cause of the CSRF missing issue?
        ...
        protected function setPostContentLoadPlaceholders() {
            ...
            $this->template->setVariable(array(
                ...
                'LOGIN_URL'                      => '<a href="' . contrexx_raw2xhtml(\Env::get('init')->getUriBy('section', 'Login')) . '" class="start-frontend-editing" rel="nofollow">' . $_CORELANG['TXT_FRONTEND_EDITING_LOGIN'] . '</a>',
