 ...
 */
class CxCoreLocaleModelEntityBackendProxy extends \Cx\Core\Locale\Model\Entity\Backend implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'iso_1', 'language');
    }
