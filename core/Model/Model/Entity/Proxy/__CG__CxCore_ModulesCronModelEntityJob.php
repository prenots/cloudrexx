...
namespace Cx\Core\Model\Model\Entity\Proxy\__CG__\Cx\Core_Modules\Cron\Model\Entity;
...
class Job extends \Cx\Core_Modules\Cron\Model\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'active', 'expression', 'command', 'lastRan', 'validators', 'virtual');
        }
